...
const notFound = () => {
  return (
    <>
      <Head>
        <title>Prosper | notFound</title>
        <meta name="keywords" content="people" />
      </Head>
      <motion.div className={styles.svg} initial={{opacity: 0 }} animate={{opacity: 1}} transition={{duration:1, ease: "easeIn"}}>
        <svg
        ...
        >
          <g transform="translate(68.112 53.128)">
            ...
            />
            <path
              className={styles.svg__character}
          ...
          <defs>
            ...
            />
            <mask id="pathMask">
              <use className={styles.svg__mask} href="#path">
                <animate
            ...
            <g id="plane" className={styles.svg__plane}>
              <path
   ...
   C6.3,2,6.9,1.9,7.5,2l7.7,1.1l4.5-2.7c0.7-0.4,1.4-0.5,2.1-0.3c0.7,0.2,1.3,0.6,1.7,1.3L23.9,2.7z"
          ...
          <use className={styles.svg__line} href="#path" mask="url(#pathMask)" />
          <use href="#plane" />
          ...
          <g transform="translate(67.512 53.128)">
            <path
              className={styles.svg__character1}
